...
class Game:
    ...
    def draw_hud(self):
        ...
        px.draw_text(s, "ARTHUR", 40, 22, (229, 229, 220), scale=5)
        ...
        px.draw_text(s, "COSMO", 40, 94, (202, 178, 119), scale=3)
        self.bar(130, 98, 310, p.cosmo / 100, (186, 155, 82))
        if p.cosmo >= 100:
    ...
    def draw(self):
        ...
        if self.state == "title":
            ...
            self.draw_center("GOBLIN", 230, (222, 201, 150), 24)
